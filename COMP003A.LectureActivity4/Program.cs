 ...
 * Course: Comp-003A
 * Purpose: Lecture 4 Activity (loops!)
...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("".PadRight(50, '*'));
            int limit = 10;
            for (int counter = 0; counter < limit; counter++) { Console.WriteLine($"\tCurrent counter: {counter}"); }
            Console.WriteLine("\n");
            ...
            foreach (var item in simpleArray) { Console.WriteLine($"\tCurrent item: {item}"); }
